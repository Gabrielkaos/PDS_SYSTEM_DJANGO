...
class EducationalBackground(models.Model):
    ...
    elementary_name = models.CharField(max_length=255, blank=True, null=True, verbose_name="Elementary - Name of School")
    ...
    elementary_period_from = models.CharField(max_length=4, blank=True, null=True, verbose_name="Elementary - Period of Attendance (From)")
    elementary_period_to = models.CharField(max_length=4, blank=True, null=True, verbose_name="Elementary - Period of Attendance (To)")
    ...
    secondary_name = models.CharField(max_length=255, blank=True, null=True, verbose_name="Secondary - Name of School")
    ...
    secondary_period_from = models.CharField(max_length=4, blank=True, null=True, verbose_name="Secondary - Period of Attendance (From)")
    secondary_period_to = models.CharField(max_length=4, blank=True, null=True, verbose_name="Secondary - Period of Attendance (To)")
    ...
    college_name = models.CharField(max_length=255, blank=True, null=True, verbose_name="College - Name of School")
    college_degree_course = models.CharField(max_length=255, blank=True, null=True, verbose_name="College - Basic Ed/Degree/Course")
    college_period_from = models.CharField(max_length=4, blank=True, null=True, verbose_name="College - Period of Attendance (From)")
    college_period_to = models.CharField(max_length=4, blank=True, null=True, verbose_name="College - Period of Attendance (To)")
